...
export const clubStatusEnum = z.enum([
  "DRAFT",
  "ACTIVE",
  "INACTIVE",
  "SUSPENDED",
...
export const clubSchema = z.object({
  ...
  mission: z
    .string()
    .max(2000, "Mission must be at most 2000 characters")
    .optional(),
  vision: z
    .string()
    .max(2000, "Vision must be at most 2000 characters")
    .optional(),
  values: z
    .array(z.string().max(100, "Value must be at most 100 characters"))
  ...
  meetingSchedule: z
    .string()
    .max(500, "Meeting schedule must be at most 500 characters")
    .optional(),
  ...
  membershipRequirements: z
    .string()
    .max(1000, "Requirements must be at most 1000 characters")
    .optional(),
...
export const joinClubSchema = z.object({
  ...
  applicationMessage: z
    .string()
    .max(500, "Application message must be at most 500 characters")
    .optional(),
});
