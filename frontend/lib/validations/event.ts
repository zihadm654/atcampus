...
export const eventSchema = z.object({
  ...
  maxAttendees: z
    ...
    .max(10_000, "Max attendees must be at most 10000"),
  ...
  tags: z
    ...
    .optional(),
  speakers: z
    .array(z.string().max(200, "Speaker name must be at most 200 characters"))
    .max(10, "Maximum 10 speakers allowed")
    .optional(),
  agenda: z
    .string()
    .max(5000, "Agenda must be at most 5000 characters")
    .optional(),
});
...
export const joinEventSchema = z.object({
  ...
  registrationNote: z
    .string()
    .max(500, "Registration note must be at most 500 characters")
    .optional(),
});
