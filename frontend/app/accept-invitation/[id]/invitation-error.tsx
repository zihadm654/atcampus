    ...
    switch (type) {
      ...
      default:
        return {
          ...
          message:
            error ||
            "The invitation you're trying to access is either invalid or you don't have Professor account or you don't have the correct permissions. Please check your email for a valid invitation or contact the person who sent it.",
          titleColor: 'text-destructive',
        };
    }
  };
