...
import type { ProfileUserData, ProfilePermissions, ExtendedOrganization } from "@/types/profile-types";
                    ...
                    <CardContent className="pt-4">
                        <div className="text-center py-8 text-gray-500">
                            ...
                            {permissions.canEdit && isOwnProfile && (
                                <p className="text-sm mt-2">Add schools and faculties to get started</p>
                            )}
                        </div>
                    </CardContent>
                </Card>
