...
import type { ProfileUserData, ProfilePermissions, Course, Research } from "@/types/profile-types";
                            ...
                            <div>
                                ...
                                {user.members && user.members.length > 0 && (
                                    <p className="text-sm text-gray-500">
                                        {user.members[0].title} • {user.members[0].department}
                                    </p>
                                )}
                            </div>
                    ...
                    <CardContent className="pt-4">
                        <div className="text-center py-8 text-gray-500">
                            ...
                            {permissions.canEdit && isOwnProfile && (
                                <p className="text-sm mt-2">Add research to showcase your work</p>
                            )}
                        </div>
                    </CardContent>
                </Card>
