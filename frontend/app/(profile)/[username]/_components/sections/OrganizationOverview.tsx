...
import type { ProfileUserData, ProfilePermissions, Member, Job } from "@/types/profile-types";
...
export default function OrganizationOverview({
    ...
    const uniqueMembers = members ? Array.from(new Set(members.map(m => m.userId))) : [];
